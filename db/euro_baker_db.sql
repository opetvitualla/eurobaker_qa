...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2020 at 04:02 AM
...
(23, 1, 1, 0, 3, 1, 'purchase', 0, '2020-07-13', '2020-07-28'),
...
--
ALTER TABLE `eb_inventory_movement`
  MODIFY `pk_inv_move_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `eb_stock_transfer_received`
  MODIFY `PK_st_received_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
