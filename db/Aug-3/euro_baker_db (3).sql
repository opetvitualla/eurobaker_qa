...
(23, 1, 1, 0, 1, 1, 'transfer', 0, '2020-07-13', '2020-07-30'),
(24, 2, 1, 0, 36, 1, 'purchase', 0, '2020-07-13', '2020-07-28'),
...
(2, 'purchaser', '123456', 2, 1, '1', '2020-03-31 00:00:00'),
...
--
ALTER TABLE `eb_inventory_movement`
  MODIFY `pk_inv_move_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `eb_stock_transfer`
  MODIFY `PK_stock_transfer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `eb_stock_transfer_items`
  MODIFY `PK_transfer_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
